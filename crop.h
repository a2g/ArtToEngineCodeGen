    ...
    namespace github
    {
        namespace a2g
        {
            namespace generator
            {
                ...
                {
                private:
                    static QRect getBoundingNonBlackRectangle(QImage image)
                    {
                    ...
                    static QImage generateZBufferRepresentation(QImage image,QRgb zbufferColor)
                    {
                    ...
                    static QDateTime getSaveTime(QString fullPath)
                    {
                        QFile file(fullPath);
                    ...
                    static QString getXmlFileForPng(QString pngFile)
                    {
                        return pngFile+".xml";
                    }

                    static QRect getCachedRectFromXml(QString pngFile)
                    {
                    ...
                    static bool isTimestampOfXmlMatchingTimestampOfPng(QString pngFile)
                    {
                        QByteArray debug = pngFile.toUtf8();
                    ...
                    static void saveTimestampXml(QString pngFile,QRect rect)
                    {
                        QDateTime pngSaveTime = getSaveTime(pngFile);
