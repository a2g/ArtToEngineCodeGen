...
namespace  //anonymous for linker errors
{
    ...
    const char* EXPECTED =
        "public static ISingleBundle VINES2_PLACEHOLDER(){return new Loader().new VINES2_PLACEHOLDER();}\n"
    ...
    {
        std::string blah = com::github::a2g::generator::writeGwtClass("com.visuals.canoe.canoe", "VINES2_PLACEHOLDER").toUtf8().data();
